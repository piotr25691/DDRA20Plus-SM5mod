...
local function RivalScore(pn,rival)
    ...
    return Def.ActorFrame{
        Def.Sprite{
            Texture=ddrgame.."ScoreBack01",
            InitCommand=function(s) s:valign(0):zoomx(pn==PLAYER_1 and 0.95 or -0.95):zoomy(0.95):xy(pn==PLAYER_1 and -10 or 10,40) end,
        };
        Def.Sprite{
        ...
        Def.Sprite{
            Texture="ScoreBack02",
            InitCommand=function(s) s:valign(0):zoom(0.64):xy(pn==PLAYER_1 and 123 or -123,36) end,
        };
        RivalScore(pn,1)..{
