...
t[#t+1] = LoadActor(ddrgame.."NameBacker")..{
		InitCommand=cmd(x,SCREEN_LEFT+80;y,SCREEN_CENTER_Y-268-3;player,PLAYER_1;zoomx,1.073;zoomy,1.092);
		OffCommand=cmd(linear,0.15;addx,-300);
	};
...
t[#t+1] = LoadActor(ddrgame.."NameBacker")..{
		InitCommand=cmd(x,SCREEN_RIGHT-80;y,SCREEN_CENTER_Y-268-3;player,PLAYER_2;zoomx,-1.073;zoomy,1.092);
		OffCommand=cmd(linear,0.15;addx,300);
	};
