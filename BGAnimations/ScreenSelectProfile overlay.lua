...
function LoadCard(cColor,cColor2,Player,IsJoinFrame)
	local t = Def.ActorFrame {
		LoadActor( THEME:GetPathG("ScreenSelectProfile","CardBackground") ) .. {
		 ...
		 LoadActor( THEME:GetPathG(ddrgame.."ScreenSelectProfile","CardBG02") ) .. {
		...
		-- };
					...
					--上下框架------------
		LoadActor( THEME:GetPathG(ddrgame.."ScreenSelectProfile","CardFrameA") )..{
			Name = "Frame";
		...
		LoadActor( THEME:GetPathG(ddrgame.."ScreenSelectProfile","CardFrameWBase") )..{
			Name = "Frame";
			InitCommand=cmd(x,0;y,0;zoom,0);
...
function LoadPlayerStuff(Player)
	...
	t[#t+1] = LoadActor( THEME:GetPathG(ddrgame.."ScreenSelectProfile",lang.."_CardFrameWord") )..{
		Name = "FrameInstWord";
...
if THEME:GetCurLanguage() == "ja" then
	...
	t[#t+1] = LoadActor( THEME:GetPathG(ddrgame.."ScreenSelectProfile","CardFrameWBase") )..{
		Name = "FrameInstWBase";
