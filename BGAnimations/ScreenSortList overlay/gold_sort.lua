...
local t = Def.ActorFrame{
	...
	LoadActor("gold_Backer")..{
		OnCommand=function(s) s:xy(-6,48):zoomy(0):decelerate(0.2):zoomy(1) end,
	},
	Def.ActorFrame{
		OnCommand=function(s) s:x(-6):valign(1):y(0):decelerate(0.2):y(-190) end,
		LoadActor("gold_Header")..{
			InitCommand=function(s) s:valign(1) end,
		},
		LoadActor(lang.."_title.png")..{
			InitCommand=function(s) s:xy(38,-36) end,
		}
	};
	LoadActor("gold_Bottom")..{
		OnCommand=function(s) s:x(-6):valign(0):y(0):decelerate(0.2):y(284) end,
	},
	Def.ActorScroller{
		SecondsPerItem=0;
		NumItemsToDraw=20;
