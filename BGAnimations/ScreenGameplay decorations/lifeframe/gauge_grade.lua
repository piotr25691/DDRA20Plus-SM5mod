        ...
        HealthStateChangedMessageCommand=function(self, param)
			if param.PlayerNumber == pn then
				...
				elseif param.HealthState == "HealthState_Hot" then
					self:Load(THEME:GetPathB("","ScreenGameplay decorations/lifeframe/stream/gauge0000_gauge_grade (stretch).png"))
		  		else
					self:Load(THEME:GetPathB("","ScreenGameplay decorations/lifeframe/stream/gauge0000_gauge_grade (stretch).png"))
					self:texcoordvelocity(pn=="PlayerNumber_P2" and 0.9 or -0.9,0)
		  		end;
