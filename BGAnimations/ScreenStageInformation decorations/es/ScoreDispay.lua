...
t[#t+1]=Def.ActorFrame{
	LoadActor("Score_Back_t")..{
		...
		OnCommand=cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX);
	};
	--FC Ring
	LoadActor(THEME:GetPathG("StageIn","Spin FullCombo"))..{
		...
		OnCommand=function(self)
			...
			self:diffusealpha(0);
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX+167))(self);
		end;
	};
	...
	Def.Quad{
		...
		OnCommand=function(self)
			...
			--self:diffusealpha(1);
			self:diffusealpha(0);
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX+135))(self);
		end;
	};
	...
	Def.RollingNumbers { -- Topscore
		...
		OnCommand=function(self)
			...
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-40))(self);
		end;
	};
...
t[#t+1]=Def.ActorFrame{
	...
	InitCommand=cmd(x,SCREEN_LEFT-OffsetX-28;y,SCREEN_CENTER_Y+153;zoom,0.85);
		OnCommand=cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-28);
	...
	LoadFont("_helveticaneuelt pro 65 md 24px") .. {
		...
		OnCommand=function(self)
			...
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-40+100))(self);
		end;
	};
...
LoadFont("_helveticaneuelt pro 65 md 24px") .. {
	...
	OnCommand=function(self)
		(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-60-110))(self);
	end;
};
...
t[#t+1]=Def.ActorFrame{
	...
	InitCommand=cmd(x,SCREEN_RIGHT+OffsetX;y,SCREEN_CENTER_Y+200;zoom,1.5);
		OnCommand=cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX);
		
};
	
	LoadActor("../ScreenGameplay decorations/frame2")..{
	InitCommand=cmd(x,SCREEN_RIGHT+OffsetX+28;y,SCREEN_CENTER_Y+153;zoom,0.85);
		OnCommand=cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX+28);
	...
	OnCommand=function(self)
			...
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX+167))(self);
		end;
	};
	...
	InitCommand=cmd(player,PLAYER_2;zoom,0.35;shadowlength,1;x,SCREEN_RIGHT+287-OffsetX;y,SCREEN_CENTER_Y+188;horizalign,center;draworder,2;);
		...
		OnCommand=function(self)
			...
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX+135))(self);
		end;
	};
	...
	Def.RollingNumbers { -- Topscore
			...
			OnCommand=function(self)
				...
				(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX-40))(self);
			end;
};	
...
LoadFont("_helveticaneuelt pro 65 md 24px") .. {
	...
	OnCommand=function(self)
		...
		(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX-60+120))(self);
	end;
};
...
LoadFont("_helveticaneuelt pro 65 md 24px") .. {
	...
	OnCommand=function(self)
		(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX-60-110))(self);
	end;
};
...
if not GAMESTATE:IsCourseMode() then --Difficulty
	...
	t[#t+1]=LoadFont("_compacta blk bt 14px") .. {
		...
		InitCommand=cmd(maxwidth,240;zoomx,1.5;zoomy,1;x,SCREEN_LEFT-OffsetX-123;y,SCREEN_CENTER_Y+156;horizalign,center;diffuse,CustomDifficultyToColor( ToEnumShortString(GAMESTATE:GetCurrentSteps(PLAYER_1):GetDifficulty()) ));
		OnCommand=function(self)
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-123))(self);
		end;
	};
	...
	t[#t+1]=LoadFont("_compacta blk bt 14px") .. {
		...
		InitCommand=cmd(maxwidth,240;zoomx,1.5;zoomy,1;x,SCREEN_RIGHT+OffsetX+123;y,SCREEN_CENTER_Y+156;horizalign,center;diffuse,CustomDifficultyToColor( ToEnumShortString(GAMESTATE:GetCurrentSteps(PLAYER_2):GetDifficulty()) ));
		OnCommand=function(self)
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX+123))(self);
		end;
	};
	...
	t[#t+1]=LoadFont("_compacta blk bt 14px") .. {
		...
		OnCommand=function(self)
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_LEFT+OffsetX-125))(self);
		end;
	};
	...
	t[#t+1]=LoadFont("_compacta blk bt 14px") .. {
		...
		OnCommand=function(self)
			(cmd(sleep,SleepOffset+0.2;linear,0.05;x,SCREEN_RIGHT-OffsetX+125))(self);
		end;
	};
	end;
