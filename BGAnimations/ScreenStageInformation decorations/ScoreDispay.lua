...
t[#t+1]=Def.ActorFrame{
	...
	InitCommand=cmd(x,SCREEN_LEFT-OffsetX;y,SCREEN_CENTER_Y+200;zoom,2;zoomx,1.9);
...
t[#t+1]=Def.ActorFrame{
	LoadActor("Score_Back_a")..{
	InitCommand=cmd(x,SCREEN_RIGHT+OffsetX;y,SCREEN_CENTER_Y+200;zoom,2;zoomx,1.9);
