...
t[#t+1] = Def.ActorFrame{
	Def.Sprite{
		InitCommand = function(s) s:draworder(98):player(pn):x(pn==PLAYER_1 and SCREEN_CENTER_X-263 or SCREEN_CENTER_X+361):y(SCREEN_TOP+194):zoom(0) end,
...
t[#t+1] = Def.ActorFrame{
	Def.Sprite{
		...
		InitCommand = function(s) s:x(pn==PLAYER_1 and SCREEN_CENTER_X-350 or SCREEN_CENTER_X+280):y(SCREEN_TOP+194) end,
