...
for _,pn in pairs(GAMESTATE:GetEnabledPlayers()) do
    t[#t+1] = Def.ActorFrame{
        InitCommand=function(s) s:xy(pn==PLAYER_1 and SCREEN_LEFT+60 or SCREEN_RIGHT-80,_screen.cy-268) s:zoomx(pn==PLAYER_1 and 1 or -1) end,
    ...
    t[#t+1] = Def.ActorFrame{
        ...
        Def.Sprite{
            Texture="Score_Label",
            InitCommand=function(s) s:x(pn==PLAYER_1 and -124 or -5) s:y(pn==PLAYER_1 and -36 or -36) end,
        };
        Def.RollingNumbers{
            File="ScreenEvaluation ScoreNumber",
            InitCommand=function(s)
                s:x(pn==PLAYER_1 and 0 or 120):playcommand("Set")
            end,
