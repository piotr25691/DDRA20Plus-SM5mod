    ...
    t[#t+1] = Def.ActorFrame{
        ...
        Def.ActorFrame{
            InitCommand=function(s)
                s:y(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and SCREEN_TOP+134 or (yval-30)):zoomx(1.02)
            end,
            Def.Sprite{
                Texture=ddrgame.."dance_score0000_level_base_none",
                InitCommand=function(s) s:x(pn==PLAYER_1 and SCREEN_LEFT+74 or SCREEN_RIGHT-1400):y(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and -60 or 0):rotationx(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and 180 or 0) end,
            };
            Def.ActorFrame{
                InitCommand=function(s) s:x(pn==PLAYER_1 and SCREEN_LEFT-88 or SCREEN_RIGHT-1555):y(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and -60 or 0) end,
                Def.Sprite{
                ...
                Def.BitmapText{
                    ...
                    SetCommand=function(s)
                        ...
                        if diff then
                            ...
                            s:xy(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and 30+additionXPos or 30+additionXPos,GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and 0 or 2)
                        end
                    end
                };
                Def.BitmapText{
                    ...
                    SetCommand=function(s)
                        ...
                        s:settext(meter):xy(GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and 35+additionXPos or 35+additionXPos,GAMESTATE:PlayerIsUsingModifier(pn,'reverse') and -2 or 0)
                    end,
                };
            };
        ...
        Def.ActorFrame{
            InitCommand=function(s) s:y(yval+2) s:x(pn==PLAYER_1 and SCREEN_LEFT+0 or SCREEN_RIGHT-1475) end,
            Def.Sprite{
